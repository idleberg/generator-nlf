...
module.exports = class extends Generator {
  constructor(args, opts) {
    ...
    this.storeStrings = (this.options.looseVersion ? true : false);
  }
    ...
    return this.prompt([
      {
        ...
        store: true,
        validate: name => (name.trim().length > 0 && /^[a-zA-Z ]+$/.test(name)) ? true : 'Specify a valid language name'
      },
      {
        name: 'language',
      ...
      },
      {
        ...
        default: answers => (languageData.languages[answers.language].font.name) ? languageData.languages[answers.language].font.name : '-' ,
      },
      {
        name: 'fontSize',
      ...
      },
      {
        ...
        type: 'confirm',
        default: answers => (languageData.languages[answers.language].rtl === 'RTL') ? true : false ,
      },
      {
      ...
      },
      {
          ...
          when: answers => answers.translateStrings ? true : false,
      ...
      this.fs.copyTpl(
        this.templatePath('template.nlf.ejs'),
        this.destinationPath(`${props.name}.nlf`),
        {
          pkg: props
        }
      );
